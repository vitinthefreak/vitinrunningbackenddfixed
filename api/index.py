...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "13449"  # Playfab Title Id
        self.SecretKey: str = "NHYJF5FP7SHQKQ1AU55UYPHQQHAZB4WBTJXCOFAJE4KQYSYETU"  # Playfab Secret Key
        self.ApiKey: str = "OC|1184115174791506|72ce9e5acc12fe80f2f492c249eec507"  # App Api Key (Oculus/Graph API)
...
def titledata():
    response_data = {
        ...
        "TOS_2024.09.20": "EU NAO SEI COMO ARRUMAR ESSE TREM by vitin",
